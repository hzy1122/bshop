            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/adminRacketAdd" method="post" class="row" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" id="appraise" name="appraise" rows="5"placeholder="评分">
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="handleId" name="handleId">
                                    ...
                                    <c:forEach var="handle" items="${requestScope.handleList}">
                                        <option value="${handle.id}" }>${handle.value}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="weightId" name="weightId">
                                    ...
                                    <c:forEach var="weight" items="${requestScope.weightList}">
                                        <option value="${weight.id}" }>${weight.value}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="placeId" name="placeId">
                                    ...
                                    <c:forEach var="place" items="${requestScope.placeList}">
                                        <option value="${place.id}" }>${place.value}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
