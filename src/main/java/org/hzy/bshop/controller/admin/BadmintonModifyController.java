...
import org.hzy.bshop.mapper.BadmintonMapper;
...
@WebServlet("/adminBadmintonModify")
public class BadmintonModifyController extends HttpServlet {
            ...
            for(FileItem fileItem:itemList){
                ...
                if(fileItem.isFormField()){
                    ...
                    if(fieldName.equals("id")){
                        badminton.setId(Integer.parseInt(fieldValue));
                    }
                    ...
                    if(fieldName.equals("imagePath")){
                        if(fieldValue.length()!=0){
                            flag = true;
                            System.out.println("imagePath===="+flag);
                        }}
